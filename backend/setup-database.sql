...
-- 2. 创建用户并授权
CREATE USER IF NOT EXISTS 'cetc38'@'localhost' IDENTIFIED BY '1234';
GRANT ALL PRIVILEGES ON study_system.* TO 'cetc38'@'localhost';
FLUSH PRIVILEGES;

-- 3. 切换到study_system数据库
USE study_system;
